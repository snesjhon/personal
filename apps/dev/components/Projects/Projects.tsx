...
const projectItems: ProjectProps[] = [
  ...
  },
  {
    ...
    link: "https://www.youtube.com/playlist?list=PLxN1mKPLtPoUFuE9-lFj9I0E_-eo3U2oi",
  ...
  },
  {
    ...
    link: "https://docs.google.com/spreadsheets/d/1ZfLCreXs221cBq6m8PfdU8863zbTJs54FxKWJs5AsjA/edit?usp=sharing",
      ...
      >
        ...
        <Box order={{ base: -1, md: 1 }}>
          <Box
            ...
            target="_blank"
          >
            <Image src={img} width={1086} height={628} alt="Project Images" />
          </Box>
        </Box>
      </Grid>
      <Divider border="1px solid black" borderColor="black" opacity={1} />
